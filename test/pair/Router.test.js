...
describe("Router", function () {
    ...
    beforeEach(async function () {
        ...
        this.factory = await this.Factory.deploy(this.money.address, this.goldenNFT.address, 1);
    ...
    it("should be able to swap tokens with eth", async function () {
        ...
        await this.router.swapExactTokensForETH(1000000000, 5, [this.firstErc20Token.address, this.weth9.address], this.alice.address, new Date().getTime())
    ...
    it("should be able to eth for tokens", async function () {
        ...
        await this.factory.createPair(this.firstErc20Token.address, this.weth9.address);
        const transactionHash = await this.router.addLiquidityETH(this.firstErc20Token.address, "1000", "10", "10", this.alice.address, new Date().getTime(), {
            value: 10000000000
        })
    ...
    it("should be able to remove liquidity", async function () {
        ...
        await this.router.removeLiquidity(this.firstErc20Token.address, this.secondErc20Token.address, 10,10,10, this.alice.address, new Date().getTime())
